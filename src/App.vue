...
<nav id ="nav" class="navbar navbar-expand-lg navbar-light bg-light">
  ...
  <a class="linija">|</a>
  <img alt="Instagram"  class="s4Iyt" src="https://www.instagram.com/static/images/web/mobile_nav_type_logo-2x.png/1b47f9d0e595.png" srcset="/static/images/web/mobile_nav_type_logo-2x.png/1b47f9d0e595.png 2x"height="29" width="103">
  </a>
   ...
   <!--  <ul class="navbar-nav mr-auto mt-2 mt-lg-0">
      ...
      <!-- nas zamjenimo s ovime 
      router-link to="/" class="nav-link">HOME  </router-link>
        - router link    <router-link to="/" class="nav-link">Home</router-link>
      </li>
      <li class="nav-item"> 
